...
### ⚙️ Параметры сборки
- `task` (выборка тестов для запуска, используем теги)
- `browser` (браузер, на выбор: Chrome и Firefox)
- `browserVersion` (версии Chrome: 127.0, 128.0; 
версии firefox: 124.0, 125.0)
- `browserSize` (размер окна браузера, доступны для выбора: 1920x1080, 1280x720,800x600)
- `environment` (окружение, доступны для выбора: stage.usetech.ru, test.usetech.ru)
